...
class Question(models.Model):
    ...
    question_text = models.TextField(max_length=700)
...
class Devoir(models.Model):
    ...
    texte = models.TextField("Texte", max_length=600, null=True, blank=True)
...
class Utilisateur(models.Model):
    ...
    niveau_actuel = models.CharField('Niveau', max_length=50, default='Niveau 1')
